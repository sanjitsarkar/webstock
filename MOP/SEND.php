...
<body>
  <section class="menu cid-qIWE4FMD4N" once="menu" id="menu1-13">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="index.php">
                        FIRST SAVE MONEY THEN MAKE IT  </a>
                    </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-primary display-4" href="https://mobirise.com"><span class="mbri-sites mbr-iconfont mbr-iconfont-btn"></span>
        ...
        echo'<a class="btn btn-sm btn-primary display-4" href="update.php?id='.$id.'">';  echo '<span class="mbri-paper-plane mbr-iconfont mbr-iconfont-btn"></span></a>';
                    ?></div>
                     <a class="text-white"> <?php echo" Hi, ".$_SESSION['email']." "; ?>
                     </a>
                 </br>
                <a href="index.php?logout='1'" style="color:#149DCC; font-weight: bold;">        logout</a>
        </div>
    </nav>
</section>

<section class="engine"><a href="https://mobirise.ws">Mobirise</a></section><section class="mbr-section content4 cid-qIFg3TsGYT" id="content4-q">
...
<section class="mbr-section form1 cid-qITVmsg7SB" id="form1-v">
    ...
    <div class="container">
 <form class="mbr-form" action="SEND.php" method="post" data-form-title="Mobirise Form" enctype="multipart/form-data">
